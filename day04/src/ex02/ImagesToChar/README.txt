# Compilation:
 ...
 cd target ; jar xf ../lib/JColor-5.5.1.jar com ; jar xf ../lib/jcommander-1.78.jar com ; cd ..

  # this command compiles .java files into .class files, put them into target directory
 javac -cp target -d ./target/ src/java/edu/school21/printer/*/*.java
...
# Launch jar application:
 java -jar target/images-to-chars-printer.jar --white=BLACK --black=WHITE